...
@section('content')
    ...
    <h2>Редагувати  Видавництво</h2>
    <form method="post" name="Books" action="/publishers/{{$model->publisher_id}}" style="width: 450px;height:250px ">
        {{method_field("PUT")}}
        <input type="text" value="{{$model->name}}" class="input_form" name="name"> <label>Назва</label><br>
        ...
        <input type="text"  value="{{$model->contact_person}}" class="input_form" name="contact"> <label style="margin-bottom: 15px">Контактна особа</label><br>
