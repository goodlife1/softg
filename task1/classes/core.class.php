...
abstract class Core
{
    ...
    {
        $this->file_path = ROOT . "/templates/default/files/library.txt";
        $path = ROOT . "/templates/default/main.php";
        $content_temp = file_exists($path) ? file_get_contents($path) :
            "file main.php is not find";
        $content_temp = str_replace("%path%", "/templates/default", $content_temp);
